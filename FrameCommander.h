...
//		rt1->BindAsTarget(gfx);			// solid shading outline
//		Stencil::Resolve(gfx, Stencil::Mode::Off)->Bind(gfx);
...
//		rt2->BindAsTarget(gfx);		  // horizontal blur pass result goes rt2
//		rt1->BindAsTexture(gfx, 0);	  // solid shading outline as texture
//		pVbFull->Bind(gfx);
//		pIbFull->Bind(gfx);
//		pVsFull->Bind(gfx);
