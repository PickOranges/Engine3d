...
{
	ImGui::SliderFloat("Width", &width, 0.01f, 4.0f, "%.2f", 1.f);
	ImGui::SliderFloat("Height", &height, 0.01f, 4.0f, "%.2f", 1.f);
	ImGui::SliderFloat("Near Z", &nearZ, 0.01f, 400.0f, "%.2f", 1.0f);
	ImGui::SliderFloat("Far Z", &farZ, 0.01f, 400.0f, "%.2f", 1.0f);
}