...
void Projection::RenderWidgets(Graphics& gfx)
{
	...
	dcheck(ImGui::SliderFloat("Width", &width, 0.01f, 4.0f, "%.2f", 1.f));
	dcheck(ImGui::SliderFloat("Height", &height, 0.01f, 4.0f, "%.2f", 1.f));
	dcheck(ImGui::SliderFloat("Near Z", &nearZ, 0.01f, farZ - 0.01f, "%.2f", 1.f));
	dcheck(ImGui::SliderFloat("Far Z", &farZ, 0.01f, nearZ + 0.01f, "%.2f", 1.f));
