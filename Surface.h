...
public:
	class ExceptionSurface : public Exception
	{
	public:
		ExceptionSurface(int line, const char* file, std::string note, std::optional<HRESULT> hr = {}) noexcept;
		ExceptionSurface(int line, const char* file, std::string filename, std::string note, std::optional<HRESULT> hr = {}) noexcept;
